...
class Thread : public MessageQueue {
 public:
  ...
  virtual void Send(const base::Location& posted_from,
  ...
  ReturnT Invoke(const base::Location& posted_from, const FunctorT& functor) {
 ...
 private:
  ...
  void InvokeInternal(const base::Location& posted_from, MessageHandler* handler);
...
class SocketServerScope {
 ...
 private:
  ...
  SocketServerScope() = delete;
  DISALLOW_COPY_AND_ASSIGN(SocketServerScope);
};
