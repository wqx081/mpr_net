...
//   int main() {
//     Foo foo;
//     cout << base::Bind(&Foo::Test1, &foo)() << endl;
//     cout << base::Bind(&Foo::Test2, &foo)() << endl;
//     cout << base::Bind(&Foo::Test3, &foo, 3)() << endl;
//     cout << base::Bind(&Foo::Test4, &foo, 7, 8.5f)() << endl;
//   }
//
...
//       invoker.AsyncInvoke(RTC_FROM_HERE,base::Bind(&Bar::Test, this));
//     }
//   };
//
//   int main() {
//     base::scoped_refptr<Bar> bar = new base::RefCountedObject<Bar>();
//     auto functor = base::Bind(&Bar::Test, bar);
//     bar = nullptr;
...
// base::scoped_refptr<T>, i.e. types that implements nullary functions AddRef()
...
class MethodFunctor7 {
 ...
 private:
  ...
  typename base::remove_reference<P5>::type p5_;
  typename base::remove_reference<P6>::type p6_;
  typename base::remove_reference<P7>::type p7_;
};
...
class MethodFunctor8 {
 ...
 private:
  ...
  typename base::remove_reference<P6>::type p6_;
  typename base::remove_reference<P7>::type p7_;
  typename base::remove_reference<P8>::type p8_;
};
...
class MethodFunctor9 {
 ...
 private:
  ...
  typename base::remove_reference<P7>::type p7_;
  typename base::remove_reference<P8>::type p8_;
  typename base::remove_reference<P9>::type p9_;
};
