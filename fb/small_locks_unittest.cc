...
using std::string;
using fb::MicroSpinLock;
using fb::PicoSpinLock;
using fb::MSLGuard;
...
FB_PACK_PUSH
struct ignore1 { MicroSpinLock msl; int16_t foo; } FB_PACK_ATTR;
struct ignore2 { PicoSpinLock<uint32_t> psl; int16_t foo; } FB_PACK_ATTR;
